        ...
        <div className="space-y-6 mr-14 order-last md:order-first">
          ...
          <div className="flex space-x-4">
            <div className="flex space-x-4 my-4 md:my-0 text-white text-xl">
              ...
              <a
                className="w-14 h-14 flex items-center justify-center rounded-full border-2 hover:bg-[#C13584] border-white mb-4"
              ...
              <a
                className="w-14 h-14 flex items-center justify-center rounded-full border-2 hover:bg-[#0A66C2] border-white mb-4"
